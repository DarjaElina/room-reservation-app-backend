...
export type AllVenuesQuery = {
  __typename?: 'Query';
  allVenues: Array<{ __typename?: 'Venue'; name: string; code: string }>;
};
...
export type AllEquipmentQuery = {
  __typename?: 'Query';
  allEquipment: Array<{ __typename?: 'Equipment'; name: string }>;
};
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'accessoriesIds' },
          },
          type: {
            kind: 'ListType',
            type: {
