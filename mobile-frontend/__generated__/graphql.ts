...
export type BookingsQuery = { __typename?: 'Query', bookings: Array<{ __typename?: 'Booking', endDate: any, id: string, startDate: any, user: { __typename?: 'User', familyName: string, givenName: string } }> };
