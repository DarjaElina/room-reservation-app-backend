...
export type CreateBookingMutationVariables = Exact<{
  roomId: Scalars['ID']['input'];
  bookingTime: Array<Scalars['Date']['input']> | Scalars['Date']['input'];
  title?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type UpdateBookingMutation = { __typename?: 'Mutation', updateBooking: { __typename?: 'Booking', title?: string | null, id: string, bookingTime: Array<{ __typename?: 'BookingTimeItem', value: any }> } };
...
export type FindRoomQuery = { __typename?: 'Query', findRoom?: { __typename?: 'Room', id: string, isFree?: boolean | null, code: string, pictureUrl?: string | null, isBookable: boolean, size: number, description: string, type: RoomType, equipment: Array<{ __typename?: 'Equipment', name: string, id: string }>, venue: { __typename?: 'Venue', name: string } } | null };
